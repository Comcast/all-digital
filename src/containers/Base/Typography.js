...
const Typography = () => (
  <PageSection>
    ...
    <dl>
      ...
      <dt>Startup</dt>
      <dd>
        A startup company or startup is a company or temporary organization designed to search
        for a repeatable and scalable business model.
      </dd>
      <dt>#dowork</dt>
      <dd>
        Coined by Rob Dyrdek and his personal body guard Christopher “Big Black” Boykins,
        “Do Work” works as a self motivator, to motivating your friends.
      </dd>
      <dt>Do It Live</dt>
      <dd>
        I’ll let Bill O’Reilly will
        <a title="We'll Do It Live" href="https://www.youtube.com/watch?v=O_HyZ5aW76c">explain</a>
        {' '}
        this one.
      </dd>
    </dl>
    ...
    <p>
      ...
      <a title="Code" href="http://en.support.wordpress.com/code/">FAQ</a>
      .
    </p>
    ...
    <p>
      The acronym
      <acronym title="For The Win">ftw</acronym>
      {' '}
